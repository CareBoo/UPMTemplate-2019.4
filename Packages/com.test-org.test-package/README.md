...
<root>
  ...
  ├── Editor
  │   ├── TestOrg.TestPackage.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── TestOrg.TestPackage.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── TestOrg.TestPackage.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── TestOrg.TestPackage.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `TestOrg.TestPackage`.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/TestOrg.TestPackage.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/TestOrg.TestPackage.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/TestOrg.TestPackage.Editor.Tests.asmdef`

  `Tests/Runtime/TestOrg.TestPackage.Tests.asmdef`
